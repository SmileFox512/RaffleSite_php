  ...
  <div align="center">
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="2" class="datatable">
      <tr>
        ...
        <th width="20%" bgcolor="#dddddd">
          <a href="#" onMouseover="showfloatie(floattext[3], event, '#007AC9', 250, 40)" onMouseout="hidefloatie()" class="info">Available to be Won</a>
        </th>
    ...
    <table width="102%" border="1" align="center" cellpadding="0" cellspacing="0" class="datatable">
      <tr>
        ...
        <th width="10%">
          <a href="#" onMouseover="showfloatie(floattext[7], event, '#007AC9', 250, 25)" onMouseout="hidefloatie()" class="info">Duration</a>
        </th>
        <th width="10%">
