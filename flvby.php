...
<a href="flvby.php?go=faq">Frequently Asked Questions</a>&nbsp; &nbsp;</div>
...
function frauds_list() {
  ...
  ?>
  <br><br>
  <a href="flvby.php?go=fraudchecker">Check users with same IP</a><p><div class="help">-This page displays users who have potentially tried to cheat the website. <br />-The <em>Reason</em> column explains why a user is in this list.<br />-The Admin can delete a user's name from this list.</div>
</div>
<?php
...
function users_show() {
  ...
  <br>
  <br>
<a href="flvby.php?go=fraudchecker">Check users with same IP</a><p>
...
<table width="100%" style="border:hidden">
 ...
 <tr>
  ...
  raffle  that is available to be won. </td>
 </tr>
 <tr style="border:hidden">
  <td width="10%" style="border:hidden">
  </td>
...
<br>
<a href="flvby.php?go=editcateg">Edit Support Ticket Categories</a><p>
