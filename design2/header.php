...
<a href="index.php?go=faq">Frequently Asked Questions</a>
	...
	<div class="content_title"><a href="#">Welcome!</a></div>
	  <div class="text">
		Below are the current raffles that are going on. In order to buy a ticket you must sign up. As you can see we have many winners per raffle, unlike many other websites. The prize is based on how many people enter the raffle. As people buy tickets, money is added to the pot. If 2000 people enter and pay $2 per tickets, the winning amount will be about $4000 (we take a small fee in order to run and maintain the website)!  Each raffle below displays the percentage of people who win and what the current winning prize is (this will be split among the percentage of people.) <br><br> This website is also very secure and easy to use for you! Please click "Sign Up" to register. Once you sign up you will see the great features that are available to you! Please, move your mouse over an auction category to find out more! <br>
		<span class="style2"><br>
		<span class="style3">NOTE: THESE ARE NOT REAL RAFFLES, THIS IS JUST A DEMO OF THE SCRIPT! </span></span><span class="style1"><br>
		<br>
        </span> </div>
	</div>
