...
<li class="li_nav_body"><a href="index.php">Main Page</a></li>
<?php if (isset($logged) && ($logged)) { ?>
<li class="li_nav_body"><a href="account.php">My Account</a></li>
<li class="li_nav_body"><a href="index.php?go=logout">Logout</a></li>
<li class="li_nav_body"><a href="index.php?go=support">Support</a></li>
<?php } else { ?>
<li class="li_nav_body"><a href="signup.php">Sign Up</a></li>
<li class="li_nav_body"><a href="index.php?go=login">Login</a></li>
<?php } ?>
<li class="li_nav_body"><a href="index.php?go=archive">Archive</a></li>
<li class="li_nav_body"><a href="index.php?go=faq">FAQ</a></li>
